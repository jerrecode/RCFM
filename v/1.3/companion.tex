...
% ... (rest of the document exactly as in my previous message —
%     sections, numerical plan, etc. — unchanged)

% Compilation note (delete before final submission):
% pdflatex -interaction=nonstopmode companion.tex
% bibtex companion
% pdflatex -interaction=nonstopmode companion.tex
% pdflatex -interaction=nonstopmode companion.tex
